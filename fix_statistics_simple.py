...
def fix_statistics_simple():
    """修复统计报表，使用硬编码查询而非动态字段检测"""
    ...
    # 创建备份
    with open('app_simple.py.stats_simple_bak', 'w', encoding='utf-8') as f:
        f.write(content)
...
def admin_statistics():
    ...
    return render_template(
        ...
        print("已修复admin_statistics函数，使用硬编码查询")
    else:
